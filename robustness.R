...
### alternative models (poisson) for cards
...
######## alternative models for Fouls with Fls variable (from FBREF)
# fouls
...
## models
#does aggressive play vary by skin tone? no, actually if anything darker-skinned players are less aggressive from findings below
#OLS DV tackles
...
summary(lm_tackles)
#cluster robust standard errors
lm_tackles_rob <-coeftest(lm_tackles, vcov = vcovCL, cluster = ~ Total_Data_subset$Player.x) #significant at 10%
lm_tackles_rob
